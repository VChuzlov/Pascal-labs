...
function Eiler(f: function(time: real; c,k: array of real): array of real; time, c0, k: array of real; h: real): array of array of real;
begin
...
begin
  var time := Arr(0.0, 2.0);
  var c0 := Arr(0.8, 0.2, 0.0);
  var k := Arr(0.6, 0.26, 0.1);
